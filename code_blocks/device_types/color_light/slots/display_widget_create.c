{
    ...
    s_{{prefix_lc}}_bri_slider = lv_slider_create(card);
    lv_obj_set_width(s_{{prefix_lc}}_bri_slider, lv_pct(90));
    lv_slider_set_range(s_{{prefix_lc}}_bri_slider, 1, 254);
    {
        app_driver_param_val_t init = {};
    ...
    lv_obj_add_event_cb(s_{{prefix_lc}}_bri_slider, {{prefix_lc}}_bri_slider_cb, LV_EVENT_VALUE_CHANGED, NULL);
}

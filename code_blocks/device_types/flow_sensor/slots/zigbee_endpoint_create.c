{
    ...
    ezb_zcl_flow_measurement_cluster_server_config_t meas_cfg = {
        .measured_value = EZB_ZCL_FLOW_MEASUREMENT_MEASURED_VALUE_DEFAULT_VALUE,
        .min_measured_value = EZB_ZCL_FLOW_MEASUREMENT_MIN_MEASURED_VALUE_DEFAULT_VALUE,
        .max_measured_value = EZB_ZCL_FLOW_MEASUREMENT_MAX_MEASURED_VALUE_DEFAULT_VALUE,
    };
    ...
    ESP_ERROR_CHECK(ezb_af_endpoint_add_cluster_desc(ep_desc,
        ezb_zcl_flow_measurement_create_cluster_desc(&meas_cfg, EZB_ZCL_CLUSTER_SERVER)));
    ESP_ERROR_CHECK(ezb_af_device_add_endpoint_desc(dev_desc, ep_desc));
    s_{{prefix_lc}}_zb_endpoint = {{cfg.zb_endpoint}};
    ESP_LOGI(TAG, "{{prefix_lc}}: Zigbee Flow Sensor endpoint %d", {{cfg.zb_endpoint}});
}

...
if (param_id == {{cfg.smoke_state_param}}) {
    ...
    esp_matter::attribute::update(s_{{prefix_lc}}_endpoint_id,
        chip::app::Clusters::SmokeCoAlarm::Id,
        chip::app::Clusters::SmokeCoAlarm::Attributes::SmokeState::Id, &mval);
    s_from_driver = false;
}
if (param_id == {{cfg.co_state_param}}) {
    s_from_driver = true;
    esp_matter_attr_val_t mval = esp_matter_enum8(val.u8);
    esp_matter::attribute::update(s_{{prefix_lc}}_endpoint_id,
        chip::app::Clusters::SmokeCoAlarm::Id,
        chip::app::Clusters::SmokeCoAlarm::Attributes::COState::Id, &mval);
    s_from_driver = false;
}

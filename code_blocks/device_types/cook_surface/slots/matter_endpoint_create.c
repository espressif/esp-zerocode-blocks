{
    esp_matter::endpoint::cook_surface::config_t {{prefix_lc}}_cfg;
    ...
    esp_matter::endpoint_t *ep = esp_matter::endpoint::cook_surface::create(
    ...
    ESP_LOGI(TAG, "{{prefix_lc}}: cook_surface endpoint id=%d", s_{{prefix_lc}}_endpoint_id);
}

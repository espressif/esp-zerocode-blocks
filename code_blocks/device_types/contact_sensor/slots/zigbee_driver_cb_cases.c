if (param_id == {{cfg.state_param}} && s_{{prefix_lc}}_zb_endpoint) {
    /* Driver: true = contact closed; IAS ALARM1 = alarmed (open). */
    uint16_t status = val.b ? 0 : EZB_ZCL_IAS_ZONE_ZONE_STATUS_ALARM1;

{
    esp_matter::endpoint::doorbell::config_t {{prefix_lc}}_cfg;
    ...
    esp_matter::endpoint_t *ep = esp_matter::endpoint::doorbell::create(
    ...
    ESP_LOGI(TAG, "{{prefix_lc}}: doorbell endpoint id=%d", s_{{prefix_lc}}_endpoint_id);
}
